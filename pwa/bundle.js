...
`;var Ye=class extends q{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(t){let e=xr(t.target);e?.toggleAttribute("data-sl-button-group__button--focus",!0)}handleBlur(t){let e=xr(t.target);e?.toggleAttribute("data-sl-button-group__button--focus",!1)}handleMouseOver(t){let e=xr(t.target);e?.toggleAttribute("data-sl-button-group__button--hover",!0)}handleMouseOut(t){let e=xr(t.target);e?.toggleAttribute("data-sl-button-group__button--hover",!1)}handleSlotChange(){let t=[...this.defaultSlot.assignedElements({flatten:!0})];t.forEach(e=>{let o=t.indexOf(e),r=xr(e);r&&(r.toggleAttribute("data-sl-button-group__button",!0),r.toggleAttribute("data-sl-button-group__button--first",o===0),r.toggleAttribute("data-sl-button-group__button--inner",o>0&&o<t.length-1),r.toggleAttribute("data-sl-button-group__button--last",o===t.length-1),r.toggleAttribute("data-sl-button-group__button--radio",r.tagName.toLowerCase()==="sl-radio-button"))})}render(){return I`
    ...
    `}};Ye.styles=[J,ja];p([K("slot")],Ye.prototype,"defaultSlot",2);p([Pt()],Ye.prototype,"disableRole",2);p([y()],Ye.prototype,"label",2);function xr(t){var e;let o="sl-button, sl-radio-button";return(e=t.closest(o))!=null?e:t.querySelector(o)}Ye.define("sl-button-group");var Ka=G`
...
`;var wi=(t="value")=>(e,o)=>{let r=e.constructor,i=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(n,a,s){var l;let u=r.getPropertyOptions(t),m=typeof u.attribute=="string"?u.attribute:t;if(n===m){let c=u.converter||We,h=(typeof c=="function"?c:(l=c?.fromAttribute)!=null?l:We.fromAttribute)(s,u.type);this[t]!==h&&(this[o]=h)}i.call(this,n,a,s)}};var Wa=G`
      ...
      >
        ...
        >
          <span
            ...
            style=${Ge({top:`${e}%`,left:`${t}%`,backgroundColor:this.getHexString(this.hue,this.saturation,this.brightness,this.alpha)})}
            role="application"
            aria-label="HSV"
                ...
                ${o.map(i=>{let n=this.parseColor(i);return n?I`
                    ...
                    >
                      <div
                        ...
                        style=${Ge({backgroundColor:n.hexa})}
                      ></div>
                    </div>
                  `:""})}
              </div>
...
`);for(let[f,h]of Array.from(n.children).entries())h.textContent=c[f]??""}if(r){let s=d.labels.keys.has(t),l=s||d.labels.played&&e,u=d.labels.played&&!s;a(),r.classList.toggle("label-visible",l),r.classList.toggle("has-fixed-label",s),r.classList.toggle("has-temporary-label",u),n.classList.toggle("rotated",d.labels.type=="freq");let m=d.stickers.keys.has(t),c=m?d.stickers.keys.get(t):null;r.classList.toggle("has-sticker",m),r.classList.toggle("has-sticker-red",c=="red"),r.classList.toggle("has-sticker-yellow",c=="yellow"),r.classList.toggle("has-sticker-green",c=="green"),r.classList.toggle("has-sticker-blue",c=="blue"),r.classList.toggle("has-sticker-violet",c=="violet"),o&&i.hasAttribute("press_transform")?i.style.setProperty("transform",i.getAttribute("press_transform")):i.style.removeProperty("transform")}}function Ao(){L.svg.classList.toggle("touch-input",ot.enabled),L.svg.classList.toggle("grabbing",[1,2].includes(zt.state)),L.svg.classList.toggle("marking-mode",Lt),L.svg.classList.toggle("labeling-mode",Lt=="label"),L.svg.classList.toggle("sticker-mode",Lt=="sticker")}function nc(){Vt(),ic(),Po(),Ao()}function er(){je("pedr",Gt.isSustainActive()||st.sustain_pedal_value/127),je("pedm",st.sostenuto_pedal_value/127),je("pedl",st.soft_pedal_value/127)}function Wt(){je("connection-power-icon",d.pc_keyboard_connected||ot.enabled||d.device_name&&st.getConnectedPort()),je("transpose-power-icon",d.transpose!=0),je("sound-power-icon",Ot.led,Ot.led==1?"red":null),je("labels-power-icon",Lt=="label"),je("stickers-power-icon",Lt=="sticker",{red:"red",yellow:"yellow",green:"#0b0",blue:"blue",violet:"violet"}[d.stickers.color]),v.self.toggleAttribute("hidden",!d.toolbar),v.buttons.show_toolbar.toggleAttribute("hidden",d.toolbar),v.dropdowns.pedals.toggleAttribute("hidden",ot.enabled),er()}function sc(){for(let t of Yl)t.action=="hide-elm"?t.elm.classList.toggle("condensed-toolbar-hidden-elm",!1):t.action=="hide-label"&&t.elm.classList.toggle("condensed-toolbar-hidden-label",!1);for(let t of Yl){if(v.self.scrollWidth<=v.self.clientWidth)break;t.action=="hide-elm"?t.elm.classList.toggle("condensed-toolbar-hidden-elm",!0):t.action=="hide-label"&&t.elm.classList.toggle("condensed-toolbar-hidden-label",!0)}}function Qn(){if(Ot.loading)for(let t of v.menus.sound.querySelectorAll(".menu-sound-item")){let e=t.getAttribute("value")==Ot.type;t.toggleAttribute("loading",e),t.toggleAttribute("disabled",!e),t.checked=!1}else for(let t of v.menus.sound.querySelectorAll(".menu-sound-item")){let e=t.getAttribute("value")==Ot.type;t.checked=e,t.toggleAttribute("loading",!1),t.toggleAttribute("disabled",!1)}}function es(){for(let t of v.dropdowns.size.querySelectorAll(".btn-number-of-keys")){let e=parseInt(t.value)==d.number_of_keys;t.variant=e?"neutral":null}for(let t of v.dropdowns.size.querySelectorAll(".btn-key-depth")){let e=parseFloat(t.value)==d.height_factor;t.variant=e?"neutral":null}}function ac(){v.menus.colors.picker_color_white.value=d.color_white,v.menus.colors.picker_color_black.value=d.color_black,v.menus.colors.picker_color_pressed.value=d.color_highlight,v.menus.colors.item_perspective.checked=d.perspective,v.menus.colors.item_perspective.hidden=d.lowperf,v.menus.colors.item_top_felt.checked=d.top_felt;for(let t of v.menus.colors.highlight_opacity.children)t.checked=t.value==d.highlight_opacity.toString()}function os(){v.menus.pedals.item_follow.checked=d.pedals,v.menus.pedals.item_dim.checked=d.pedal_dim,v.menus.pedals.item_dim.toggleAttribute("disabled",!d.pedals)}function or(){v.menus.labels.labeling_mode.checked=Lt=="label",v.menus.labels.played.checked=d.labels.played;let t=rc();for(let e of v.menus.labels.presets.children)e.checked=e.value===t;v.menus.labels.presets.nextElementSibling.innerText={none:"None",mc:"Middle-C",cs:"C's",white:"White",all:"All",custom:"Custom"}[t];for(let e of v.menus.labels.type.children)e.value!="octave"&&(e.checked=e.value===d.labels.type);v.menus.labels.type.nextElementSibling.innerText=d.labels.type_badge,v.menus.labels.octave.disabled=["pc","midi","freq"].includes(d.labels.type),v.menus.labels.octave.checked=d.labels.octave}function rs(){let t=Lt=="sticker";for(let e of v.menus.stickers.top.children)if(e.getAttribute("type")=="checkbox"){let o=e.value==d.stickers.color;e.checked=t&&o,e.querySelector(".menu-keyboard-shortcut").classList.toggle("invisible",!o)}v.menus.stickers.clear.disabled=d.stickers.keys.size==0}function lc(){v.menus.transpose.semitones.input.value=d.semitones,v.menus.transpose.octaves.input.value=d.octaves,v.menus.transpose.item_reset.toggleAttribute("disabled",d.transpose==0),je("transpose-power-icon",d.transpose!=0)}function Po(){let t=L.container.clientHeight/L.svg.clientHeight;d.zoom>1?(d.zoom>t&&(d.zoom=t),L.svg.style.transform=`scale(${d.zoom}, ${d.zoom})`):L.svg.style.removeProperty("transform");let e=L.svg.getBoundingClientRect(),o=L.container.getBoundingClientRect(),r=(o.height-e.height)*d.offset.y;L.svg.style.top=`${r}px`;let i=Math.round((e.width-o.width)*d.offset.x);L.container.scroll(i,0),Te.container.toggleAttribute("position-top",d.offset.y>.5)}function Jn(t){let e=t+d.transpose;e>=0&&e<128&&ro(e)}function Ui(){d.toolbar=!d.toolbar,Wt(),Po(),dt()}function is(){Ot.stopAll(!0),st.reset(),ot.reset(),Gt.resetState(),Br(),er(),v.buttons.panic.setAttribute("variant","danger"),setTimeout(()=>{v.buttons.panic.removeAttribute("variant")},1e3)}function ne(t={}){let e=d.transpose;if(t.reset&&(d.semitones=0,d.octaves=0),t.set)Object.hasOwn(t,"octaves")&&(d.octaves=Fe(t.octaves,-2,2)),Object.hasOwn(t,"semitones")&&(d.semitones=Fe(t.semitones,-11,11));else if(Object.hasOwn(t,"octaves")&&(d.octaves=Fe(d.octaves+t.octaves,-2,2)),Object.hasOwn(t,"semitones")){for(d.semitones=d.semitones+t.semitones;d.semitones>11&&d.octaves<2;)d.octaves+=1,d.semitones-=12;for(;d.semitones<-11&&d.octaves>-2;)d.octaves-=1,d.semitones+=12;d.semitones=Fe(d.semitones,-11,11)}e!=d.transpose&&Ot.stopAll(!0),lc(),Vt(),dt()}function Yo(t){d.number_of_keys=t,d.zoom=1,es(),Br(),dt()}function cc(t){d.height_factor=t,es(),Br(),dt()}function ih(){cc(cs(d.height_factor,[1,.75,.5]))}function Qo(t){d.labels.keys=oc(t),or(),Vt(),dt()}function Eo(t){d.labels.type=t,or(),Vt(),dt()}function ns(t){Lt=t||null,Ao(),Wt()}function Gi(t=void 0){t===void 0&&(t=Lt!="label"),ns(t?"label":null),or()}function eo(t=void 0,e=d.stickers.color){t===void 0&&(t=Lt!="sticker"||e!=d.stickers.color),d.stickers.color=e,ns(t?"sticker":null),rs()}function uc(){d.stickers.keys.clear(),Vt(),rs(),dt()}function dc(t=void 0){d.labels.played=t===void 0?!d.labels.played:t,or(),Vt(),dt()}function hc(t=void 0){d.labels.octave=t===void 0?!d.labels.octave:t,or(),Vt(),dt()}function nh(t=void 0){d.pedals=t===void 0?!d.pedals:t,os(),Vt(),dt()}function sh(t=void 0){d.pedal_dim=t===void 0?!d.pedal_dim:t,os(),Vt(),dt()}function dt(){z.writeBool("first-time",!1),z.writeNumber("height-factor",d.height_factor),z.writeNumber("number-of-keys",d.number_of_keys),z.writeString("color-pressed",d.color_highlight),z.writeString("color-white",d.color_white),z.writeString("color-black",d.color_black),z.writeString("labels-type",d.labels.type),z.writeBool("labels-octave",d.labels.octave),z.writeBool("labels-played",d.labels.played),z.writeString("labels-keys",d.labels.keysToStr()),z.writeString("sticker-color",d.stickers.color),z.writeString("stickers-keys",d.stickers.keysToStr()),z.writeBool("perspective",d.perspective),z.writeBool("top-felt",d.top_felt),z.writeString("highlight-opacity",d.highlight_opacity),z.writeBool("pedals",d.pedals),z.writeBool("pedal-dim",d.pedal_dim),z.writeNumber("offset-y",d.offset.y),d.device_name?z.writeString("device",d.device_name):z.remove("device"),z.writeString("sound",Ot.type),Jo.writeNumber("semitones",d.semitones),Jo.writeNumber("octaves",d.octaves),Jo.writeBool("toolbar",d.toolbar)}function ah(){d.first_time=z.readBool("first-time",!0),d.lowperf=z.readBool("lowperf",d.lowperf),d.height_factor=z.readNumber("height-factor",Ht?.75:d.height_factor),d.number_of_keys=z.readNumber("number-of-keys",Ht?20:d.number_of_keys),d.color_white=z.readString("color-white",d.color_white),d.color_black=z.readString("color-black",d.color_black),d.color_highlight=z.readString("color-pressed",d.color_highlight),d.labels.type=z.readString("labels-type",d.labels.type),d.labels.octave=z.readBool("labels-octave",d.labels.octave),d.labels.played=z.readBool("labels-played",d.labels.played),d.labels.strToKeys(z.readString("labels-keys","")),d.stickers.color=z.readString("sticker-color",d.stickers.color),d.stickers.strToKeys(z.readString("stickers-keys","")),d.perspective=z.readBool("perspective",d.perspective),d.top_felt=z.readBool("top-felt",d.top_felt),d.highlight_opacity=z.readString("highlight-opacity",d.highlight_opacity),d.pedals=z.readBool("pedals",d.pedals),d.pedal_dim=z.readBool("pedal-dim",d.pedal_dim),d.offset.y=z.readNumber("offset-y",d.offset.y),d.device_name=z.readString("device",null),d.sound=z.readString("sound",""),d.semitones=Jo.readNumber("semitones",0),d.octaves=Jo.readNumber("octaves",0),d.toolbar=Jo.readBool("toolbar",d.toolbar)}function lh(){let t=us("mode").toLowerCase();["lp","lowperf"].includes(t)?(d.lowperf=!0,z.writeBool("lowperf",!0)):["hp","highperf"].includes(t)&&(d.lowperf=!1,z.writeBool("lowperf",!1))}function je(t,e,o=null){let r=document.getElementById(t);r.classList.toggle("active",e),e&&o?r.style.color=o:r.style.removeProperty("color"),r.style.setProperty("--led-intensity",`${e*100}%`)}function ch(t=null){t===null&&(t=!d.pc_keyboard_connected),t?tr("pckbd"):ss()}function uh(t=null){t===null&&(t=!ot.enabled),t?tr("touch"):ss()}function tr(t,e=!1){switch(st.disconnect(),Ot.stopAll(),t){case"pckbd":Gt.enable(),ot.disable(),d.device_name="pckbd",Wt(),nc(),e&&dt();break;case"touch":Gt.disable(),ot.enable(),d.device_name="touch",Wt(),Vt(),e&&dt();break;default:Gt.disable(),ot.disable(),d.device_name=null,Wt(),Vt(),st.connectByPortName(t,()=>{d.device_name=t,Wt(),Te.visible&&Te.replaceStructure(Nr()),e&&dt()})}}function ss(t=!1){st.disconnect(),Gt.disable(),ot.disable(),d.device_name=null,Wt(),Vt(),t&&dt()}function Hi(t,e=!1){t&&d.device_name!=t?tr(d.device_name==t?"":t,e):ss(e)}function Co(){let t=v.menus.connect.querySelector("sl-divider");if(document.getElementById("menu-connect-item-midi-denied").toggleAttribute("hidden",yt.access!="denied"),document.getElementById("menu-connect-item-midi-unavailable").toggleAttribute("hidden",Ht||yt.access!="unavailable"),document.getElementById("menu-connect-item-midi-prompt").toggleAttribute("hidden",yt.access!="prompt"),t.toggleAttribute("hidden",yt.access=="granted"&&!yt.ports?.length||Ht&&yt.access=="unavailable"),document.getElementById("menu-connect-item-computer-keyboard").toggleAttribute("checked",d.pc_keyboard_connected),document.getElementById("menu-connect-item-touch").toggleAttribute("checked",ot.enabled),yt.access!="granted"){yt.clearMenuItems();return}let e=document.getElementById("menu-connect-item-midi-port-template");for(let o of yt.ports??[])if(!yt.menu_items.some(r=>o.name==r.value)){let r=hs(e,{value:o.name},o.name);r.addEventListener("click",i=>{Hi(i.currentTarget.value,!0)}),v.menus.connect.insertBefore(r,t)}for(let o of yt.menu_items??[])yt.ports.some(r=>o.value==r.name)?o.toggleAttribute("checked",o.value==yt.connected_port?.name):o.remove()}v.dropdowns.connect.addEventListener("sl-show",()=>{Co(),yt.setWatchdog(ts),yt.queryAccess(t=>{t!="granted"&&Co(),["granted","prompt"].includes(t)&&yt.requestAccess(e=>{Co(),e&&yt.requestPorts(Co)})})});v.dropdowns.connect.addEventListener("sl-hide",()=>{yt.setWatchdog(Vi),Wt()});v.dropdowns.sound.addEventListener("sl-show",Qn);v.dropdowns.size.addEventListener("sl-show",es);v.dropdowns.colors.addEventListener("sl-show",ac);v.dropdowns.pedals.addEventListener("sl-show",os);v.dropdowns.labels.addEventListener("sl-show",or);v.dropdowns.stickers.addEventListener("sl-show",rs);v.dropdowns.transpose.addEventListener("sl-show",lc);for(let t of v.dropdowns.all)t.addEventListener("sl-show",e=>{e.currentTarget.querySelector("sl-button").setAttribute("variant","neutral")}),t.addEventListener("sl-hide",e=>{let o=e.currentTarget.querySelector("sl-button");o.setAttribute("variant","default"),o.blur()});document.getElementById("menu-connect-item-computer-keyboard").addEventListener("click",()=>{ch(),dt()});document.getElementById("menu-connect-item-touch").addEventListener("click",()=>{uh(),dt()});v.menus.sound.addEventListener("sl-select",t=>{Ot.load(t.detail.item.value),dt()});v.dropdowns.size.querySelectorAll(".btn-number-of-keys").forEach(t=>{t.addEventListener("click",e=>{Yo(parseInt(e.currentTarget.value)),Ht&&v.dropdowns.size.hide()})});v.dropdowns.size.querySelectorAll(".btn-key-depth").forEach(t=>{t.addEventListener("click",e=>{cc(parseFloat(e.currentTarget.value)),Ht&&v.dropdowns.size.hide()})});v.menus.colors.highlight_opacity.addEventListener("sl-select",t=>{d.highlight_opacity=t.detail.item.value,dt(),ac()});v.menus.colors.item_perspective.addEventListener("click",()=>{d.perspective=!d.perspective,Br(),dt(),Ht&&v.dropdowns.colors.hide()});v.menus.colors.item_top_felt.addEventListener("click",()=>{d.top_felt=!d.top_felt,ic(),dt(),Ht&&v.dropdowns.colors.hide()});v.menus.colors.picker_color_white.addEventListener("sl-change",t=>{d.color_white=t.target.value,dt()});v.menus.colors.picker_color_black.addEventListener("sl-change",t=>{d.color_black=t.target.value,dt()});v.menus.colors.picker_color_pressed.addEventListener("sl-change",t=>{d.color_highlight=t.target.value,dt()});v.menus.labels.presets.addEventListener("sl-select",t=>{Qo(t.detail.item.value),Ht&&v.dropdowns.labels.hide()});v.menus.labels.type.addEventListener("sl-select",t=>{t.detail.item.value==v.menus.labels.octave.value?hc(t.detail.item.checked):Eo(t.detail.item.value),Ht&&v.dropdowns.labels.hide()});v.menus.labels.top.addEventListener("sl-select",t=>{t.detail.item.id==v.menus.labels.labeling_mode.id?(Gi(t.detail.item.checked),v.dropdowns.labels.hide()):t.detail.item.id==v.menus.labels.played.id&&(dc(t.detail.item.checked),Ht&&v.dropdowns.labels.hide())});v.buttons.labels_left.addEventListener("click",()=>{Gi()});v.menus.stickers.top.addEventListener("sl-select",t=>{t.detail.item.getAttribute("type")=="checkbox"&&(eo(void 0,t.detail.item.value),v.dropdowns.stickers.hide()),dt()});v.buttons.stickers_left.addEventListener("click",()=>{eo()});v.menus.stickers.clear.addEventListener("click",t=>{uc()});v.menus.pedals.top.addEventListener("sl-select",t=>{let e=t.detail.item;switch(e.id){case"menu-pedal-follow":d.pedals=e.checked;break;case"menu-pedal-dim":d.pedal_dim=e.checked;break}v.menus.pedals.item_dim.toggleAttribute("disabled",!d.pedals),er(),Vt(),dt(),Ht&&v.dropdowns.pedals.hide()});v.menus.transpose.semitones.btn_plus.onclick=()=>{ne({semitones:1})};v.menus.transpose.semitones.btn_minus.onclick=()=>{ne({semitones:-1})};v.menus.transpose.octaves.btn_plus.onclick=()=>{ne({octaves:1})};v.menus.transpose.octaves.btn_minus.onclick=()=>{ne({octaves:-1})};v.menus.transpose.item_reset.onclick=()=>{ne({reset:!0}),Ht&&v.dropdowns.transpose.hide()};v.buttons.panic.onclick=is;v.buttons.hide_toolbar.onclick=Ui;v.buttons.show_toolbar.onclick=Ui;v.title.onclick=()=>{document.getElementById("dialog-about").show()};window.addEventListener("keydown",vh);function Nr(){function t(){let i=yt.ports.map((n,a)=>[n.name,()=>Hi(n.name,!0),{checked:d.device_name==n.name}]);return i.push(["Computer keyboard",()=>Hi("pckbd",!0),{checked:d.pc_keyboard_connected}]),i.push(["Touch or mouse",()=>Hi("touch",!0),{checked:ot.enabled}]),i}function e(){if(!d.transpose)return"not transposed";let i=`${d.semitones} semitone${d.semitones!=1?"s":""}`,n=`${d.octaves} octave${d.octaves!=1?"s":""}`;return`${i}, ${n}`}function o(){return d.height_factor==1?"Full":d.height_factor==.5?"1/2":"3/4"}let r=rc();return[["",[["&Control",t()],["&Transpose",[["[\u2191] Semitone up",()=>ne({semitones:1}),{noindex:!0,key:"arrowup"}],["[\u2193] Semitone down",()=>ne({semitones:-1}),{noindex:!0,key:"arrowdown"}],["[\u2192] Octave up",()=>ne({octaves:1}),{noindex:!0,key:"arrowright"}],["[\u2190] Octave down",()=>ne({octaves:-1}),{noindex:!0,key:"arrowleft"}],["&Reset",()=>ne({reset:!0}),{noindex:!0}],[`State: ${e()}`,null]]],["&Size",[["&88 keys",()=>Yo(88),{noindex:!0,checked:d.number_of_keys==88}],["&61 keys",()=>Yo(61),{noindex:!0,checked:d.number_of_keys==61}],["&49 keys",()=>Yo(49),{noindex:!0,checked:d.number_of_keys==49}],["&37 keys",()=>Yo(37),{noindex:!0,checked:d.number_of_keys==37}],["&25 keys",()=>Yo(25),{noindex:!0,checked:d.number_of_keys==25}],[`Change key &depth (current: ${o()})`,()=>ih(),{noindex:!0}]]],["&Pedals",[["&Follow pedals",()=>nh(),{checked:d.pedals}],["&Dim pedalized notes",()=>sh(),{checked:d.pedal_dim}]]],["&Labels",[["&Toggle Labeling mode (F2)",()=>Gi(),{checked:Lt=="label"}],["&Show on played keys",()=>dc(),{checked:d.labels.played}],["&Presets",[["&None",()=>Qo("none"),{checked:r=="none"}],["&Middle-C",()=>Qo("mc"),{checked:r=="mc"}],["&C-keys",()=>Qo("cs"),{checked:r=="cs"}],["&White keys",()=>Qo("white"),{checked:r=="white"}],["&All keys",()=>Qo("all"),{checked:r=="all"}]]],["&Format",[["&English",()=>Eo("english"),{checked:d.labels.type=="english"}],["&German",()=>Eo("german"),{checked:d.labels.type=="german"}],["&Italian",()=>Eo("italian"),{checked:d.labels.type=="italian"}],["&Pitch-class",()=>Eo("pc"),{checked:d.labels.type=="pc"}],["&MIDI value",()=>Eo("midi"),{checked:d.labels.type=="midi"}],["&Frequency",()=>Eo("freq"),{checked:d.labels.type=="freq"}],["Show &octave",()=>hc(),{checked:d.labels.octave}]]]]],["Stic&kers",[["&Red",()=>eo(void 0,"red"),{checked:Lt=="sticker"&&d.stickers.color=="red"}],["&Yellow",()=>eo(void 0,"yellow"),{checked:Lt=="sticker"&&d.stickers.color=="yellow"}],["&Green",()=>eo(void 0,"green"),{checked:Lt=="sticker"&&d.stickers.color=="green"}],["&Blue",()=>eo(void 0,"blue"),{checked:Lt=="sticker"&&d.stickers.color=="blue"}],["&Violet",()=>eo(void 0,"violet"),{checked:Lt=="sticker"&&d.stickers.color=="violet"}],["&Clear",()=>uc()]]],["Panic!",is],[`${d.toolbar?"Hide":"Show"} toolbar [<u>F9</u>]`,Ui,{key:"f9"}]]]]}var Te=new jr(document.getElementById("keyboard-navigator"),Nr());Te.onmenuenter=t=>{yt.setWatchdog(t=="Control"?ts:Vi),Te.replaceStructure(Nr())};Te.onoptionenter=()=>Te.replaceStructure(Nr());Te.onshow=()=>yt.setWatchdog(ts);Te.onhide=()=>yt.setWatchdog(Vi);L.svg.oncontextmenu=t=>{zt.state>0&&t.preventDefault(),zt.state=0};L.svg.addEventListener("pointerdown",t=>{v.dropdowns.closeAll(),(t.pointerType!="touch"&&t.button!=0||!ot.enabled)&&(!Lt||t.button!=0)&&(zt.state=1,zt.origin.x=t.screenX,zt.origin.y=t.screenY,zt.previous_offset.x=d.offset.x,zt.previous_offset.y=d.offset.y,L.svg.setPointerCapture(t.pointerId),Ao())},{capture:!0,passive:!1});L.svg.addEventListener("pointerup",t=>{t.pointerType!="touch"&&zt.state&&(zt.state=zt.state==2&&t.button==2?3:0,L.svg.releasePointerCapture(t.pointerId),Po(),Ao(),dt())},{capture:!0,passive:!1});L.svg.addEventListener("pointermove",t=>{if(t.pointerType!="touch"&&zt.state){let o=L.svg.getBoundingClientRect(),r=L.container.getBoundingClientRect();zt.state=2;let n=(t.screenX-zt.origin.x)/(o.width-r.width);d.offset.x=Fe(zt.previous_offset.x-n,0,1);let a=L.container.clientHeight/L.svg.clientHeight;if(d.zoom<a-(a-1)/10){let l=(t.screenY-zt.origin.y)/(r.height-o.height);d.offset.y=Fe(zt.previous_offset.y+l,0,1),t.ctrlKey||(d.offset.y<.06&&(d.offset.y=0),d.offset.y>1-.06&&(d.offset.y=1),Math.abs(.5-d.offset.y)<.06&&(d.offset.y=.5))}Po(),Ao()}},{capture:!1,passive:!0});L.container.addEventListener("wheel",t=>{if(!zt.state&&!ot.started()&&!t.ctrlKey){let e=-t.deltaY/(t.deltaY<=0?1e3:500),o=L.container.clientHeight/L.svg.clientHeight,r=Fe(d.zoom+e,1,o);if(d.zoom!=r){let n=L.svg.getBoundingClientRect(),a=L.container.getBoundingClientRect(),s=Math.round(a.width*r);d.offset.x=(t.clientX-(t.clientX-n.left)/n.width*s-a.left)/(a.width-s),d.zoom=r}let i=t.deltaX/1e3;i&&(d.offset.x=Fe(d.offset.x-i,0,1)),Po()}t.preventDefault()},{capture:!1,passive:!1});Ht||(zi=null,L.container.addEventListener("pointermove",t=>{t.pointerType!="touch"&&(zi&&clearTimeout(zi),v.buttons.show_toolbar.toggleAttribute("visible",!0),L.container.toggleAttribute("cursor-hidden",!1),L.svg.toggleAttribute("cursor-hidden",!1),zi=setTimeout(()=>{v.buttons.show_toolbar.toggleAttribute("visible",!1),ot.enabled||(L.container.toggleAttribute("cursor-hidden",!0),L.svg.toggleAttribute("cursor-hidden",!0))},4e3))},{capture:!1,passive:!0}));var zi;function oo(t,e){let o=document.elementFromPoint(t,e)?.parentElement;return o?.classList.contains("key")?parseInt(o.getAttribute("value")):null}function pc(t,e,o,r,i){let n=ds(i),a=Math.sin(n),s=Math.cos(n);ec&&(o/=10,r/=10);let[l,u]=o>=r?[t+o*s,e+o*a]:[t-r*a,e+r*s],[m,c]=o>=r?[t-o*s,e-o*a]:[t+r*a,e-r*s],[f,h]=o>=r?[t-r*a,e+r*s]:[t+o*s,e+o*a],[g,b]=o>=r?[t+r*a,e-r*s]:[t-o*s,e-o*a],w=oo(l,u),_=oo(m,c),S=oo(f,h),E=oo(g,b),$=new Set([w,_,S,E]),D=Math.min(w,_,S,E),W=Math.max(w,_,S,E),j=W-D;if(j>1){let[X,O]=D==w?[l,u]:D==_?[m,c]:D==S?[f,h]:[g,b],[rt,k]=W==w?[l,u]:W==_?[m,c]:W==S?[f,h]:[g,b],it=(rt-X)/j,ft=(k-O)/j;for(let Y=.5;Y<j;Y+=.5){let[$t,xt]=[X+it*Y,O+ft*Y],Z=oo($t,xt);$.add(Z)}}return $.delete(null),$}function dh(t){if(v.dropdowns.closeAll(),t.pointerType!="touch"&&ot.enabled&&!Lt&&t.button===0&&!ot.started(t.pointerId)){let e=oo(t.clientX,t.clientY);e&&(ot.add(t.pointerId,new Set([e])),t.preventDefault())}}function fc(t){t.pointerType!="touch"&&ot.started(t.pointerId)&&t.button===0&&(t.preventDefault(),ot.remove(t.pointerId))}function hh(t){if(t.pointerType!="touch"&&ot.started(t.pointerId)){let e=oo(t.clientX,t.clientY);ot.change(t.pointerId,new Set([e])),t.preventDefault()}}function ph(t){if(ot.enabled&&!Lt){for(let e of t.changedTouches)if(!ot.started(e.identifier)){let o=pc(e.clientX,e.clientY,e.radiusX,e.radiusY,e.rotationAngle);o.size&&(ot.add(e.identifier,o),t.timeStamp-ot.last_vibration_time>40&&(navigator.vibrate(40),ot.last_vibration_time=t.timeStamp),t.preventDefault())}}}function mc(t){for(let e of t.changedTouches)ot.started(e.identifier)&&(ot.remove(e.identifier),t.preventDefault())}function fh(t){for(let e of t.changedTouches)if(ot.started(e.identifier)){let o=pc(e.clientX,e.clientY,e.radiusX,e.radiusY,e.rotationAngle);ot.change(e.identifier,o)==1&&t.timeStamp-ot.last_vibration_time>40&&(navigator.vibrate(40),ot.last_vibration_time=t.timeStamp),t.preventDefault()}}L.svg.addEventListener("pointerdown",dh,{capture:!0,passive:!1});L.svg.addEventListener("touchstart",ph,{capture:!0,passive:!1});window.addEventListener("pointerup",fc,{capture:!1,passive:!1});window.addEventListener("pointercancel",fc,{capture:!1,passive:!1});window.addEventListener("touchend",mc,{capture:!1,passive:!1});window.addEventListener("touchcancel",mc,{capture:!1,passive:!1});window.addEventListener("pointermove",hh,{capture:!1,passive:!1});window.addEventListener("touchmove",fh,{capture:!1,passive:!1});function mh(t){if(t.button===0){let e=oo(t.clientX,t.clientY);if(e){let o=t.ctrlKey?Array.from(Mo(e%12,128,12)):[e];if(Lt=="label"){let r=o.some(i=>!d.labels.keys.has(i));for(let i of o)d.labels.toggle(i,r)}else if(Lt=="sticker"){let r=o.some(i=>!d.stickers.keys.has(i));for(let i of o)d.stickers.toggle(i,r)}}}}L.svg.addEventListener("click",mh,{capture:!1,passive:!0});function gc(t,e){Jn(t),Ot.play(t,e)}function bc(t,e,o){o&&o<100?setTimeout(()=>Jn(t),100-o):Jn(t),Ot.stop(t,!1)}function gh(){Vt(),Ot.stopAll(!1),er()}function bh(t){t>63&&t<68&&(Vt(),Ot.stopAll(!1),er())}function yh(){Vt(),Ot.stopAll(!0),er()}st.onConnectionChange=()=>{Vt(),Wt()};st.onKeyPress=gc;st.onKeyRelease=bc;st.onControlChange=bh;Gt.onKeyPress=gc;Gt.onKeyRelease=bc;Gt.onSustain=gh;Gt.onReset=yh;function yc(){let t=v.dropdowns.connect.open;yt.queryAccess(e=>{e=="granted"?(Te.visible&&Te.replaceStructure(Nr()),yt.requestPorts(o=>{if(yt.ports=o,d.device_name&&d.device_name!="pckbd"&&d.device_name!="touch"){if(!st.getConnectedPort()){let i=o.find(n=>n.name==d.device_name);i&&st.connect(i,()=>{Wt(),t&&Co()})}Wt()}t&&Co()})):(st.disconnect(),Wt(),t&&Co())})}function vh(t){if(t.repeat)return;if(t.key=="Alt"){let i=v.dropdowns.getOpen();i&&(i.hide(),i.querySelector("sl-button[slot=trigger]").blur())}let e=new Map([["f2",Gi],["f3",eo],["f9",Ui],["escape",()=>{let i=v.dropdowns.getOpen();i?(i.hide(),i.querySelector("sl-button[slot=trigger]").blur()):Lt?ns(null):is()}],["pageup",()=>ne({semitones:1})],["pagedown",()=>ne({semitones:-1})],["shift+pageup",()=>ne({octaves:1})],["shift+pagedown",()=>ne({octaves:-1})]]),o=[];t.ctrlKey&&o.push("ctrl"),t.altKey&&o.push("alt"),t.shiftKey&&o.push("shift"),o.push(t.key.toLowerCase());let r=o.join("+");e.has(r)&&(t.preventDefault(),e.get(r)())}function _h(){v.resize.timeout&&clearTimeout(v.resize.timeout),v.resize_timeout=setTimeout(()=>{sc(),v.resize.timeout=null},d.lowperf?50:5)}function wh(){L.resize.timeout&&clearTimeout(L.resize.timeout),L.resize_timeout=setTimeout(()=>{Po(),L.resize.timeout=null},d.lowperf?50:5)}function kh(){if(ah(),lh(),document.body.classList.add("ready"),Ht&&(document.documentElement.classList.add("mobile"),v.buttons.show_toolbar.classList.add("mobile"),v.buttons.panic.parentElement.toggleAttribute("disabled",!0),v.buttons.hide_toolbar.parentElement.toggleAttribute("disabled",!0),v.buttons.show_toolbar.parentElement.toggleAttribute("disabled",!0),v.menus.size.querySelector('.btn-number-of-keys[value="20"]').toggleAttribute("hidden",!1)),ec?v.dropdowns.sound.toggleAttribute("hidden",!0):(document.getElementById("menu-sound-item-unavailable").hidden=!0,v.menus.sound.querySelectorAll(".menu-sound-item").forEach(e=>{e.hidden=!1}),Ht&&d.sound&&Ot.load(d.sound)),Wt(),Br(),d.device_name)["pckbd","touch"].includes(d.device_name)?tr(d.device_name):yt.queryAccess(e=>{e=="granted"&&tr(d.device_name)});else{let e=document.getElementById("dropdown-connect-tooltip");Ht?(tr("touch",!0),e.setAttribute("content","Play your keyboard using your fingers! Or change the input method by tapping this button.")):e.setAttribute("content","Click on this button to select an input method."),e.open=!0,window.addEventListener("click",()=>{e.open=!1},{once:!0})}function t(){sc(),v.resize.observer=new ResizeObserver(_h),v.resize.observer.observe(v.self),Po(),L.resize.observer=new ResizeObserver(wh),L.resize.observer.observe(L.container)}document.readyState!="complete"?window.addEventListener("load",t,{once:!0}):t(),yc(),yt.setWatchdog(Vi)}"serviceWorker"in navigator&&navigator.serviceWorker.addEventListener("message",t=>{if(t.data&&t.data.type==="SW_RELOAD"){let e=()=>{setTimeout(()=>window.location.reload(),1e3)};if(document.visibilityState==="visible")e();else{let o=()=>{document.removeEventListener("visibilitychange",o),e()};document.addEventListener("visibilitychange",o)}}});Promise.allSettled([customElements.whenDefined("sl-dropdown"),customElements.whenDefined("sl-button"),customElements.whenDefined("sl-button-group"),customElements.whenDefined("sl-icon"),customElements.whenDefined("sl-menu"),customElements.whenDefined("sl-menu-item")]).finally(kh);
